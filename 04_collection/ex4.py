...
print(next(gen))
print(next(gen))
for i in gen:  # Generator는 순회가 끝나면 소진됨
    print(i, end=" ")
print()
...
print(f"max점수: {max(scores)}점, min 점수:{min(scores)}점")
result = sorted(scores)
print(f"max점수: {result[-1]}점, min 점수:{result[0]}점")
